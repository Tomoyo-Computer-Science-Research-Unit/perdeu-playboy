...
const sources = [
  ...
  },
  {
    ...
    description: "Base nacional oficial usada para todos os estados cobertos pelo painel, exceto Rio de Janeiro e São Paulo, e como complemento de indicadores em SP.",
